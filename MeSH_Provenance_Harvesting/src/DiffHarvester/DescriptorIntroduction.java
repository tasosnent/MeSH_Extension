...
//                otherHosts.removeAll(siblingHosts);
     ...
     *      Columns should match with the ones in writeInCSV
     * @param writer    CSVWriter to write in
     */
    public static void writeTitlesInCSV(CSVWriter writer){
     ...
     * @param writer    CSVWriter to write in
     */
    public void writeInCSV(CSVWriter writer){
         writer.writeNext(new String[]{     
            ...
            ,"" + this.previousHostsTotal            // "PH count" 
    ...
    public String getProvenanceSerialized(){
        ...
        for(String pt : this.provenanceTypeMap.keySet()){
            if(provenanceTypeMap.get(pt) > 0){
                pts.add(this.provenanceCategory + "." + pt);
            }
        }
    ...
    public String getProvenanceCategroyFull() {
        String pl = provenanceCategory;
        if(provenanceCategory.equals("1")){
            pl += ": Old concept";
        } else if (provenanceCategory.equals("2")){
            pl += ": Old SRC";            
        } else if (provenanceCategory.equals("3")) {
            pl += ": New PI concept";            
        } else {
    ...
    public ArrayList <String> getPHMultirelated(){
        ...
        for(Descriptor p : this.previousHostsAlive){
            if( h.getHierarchicalRelations(this.d, p).size()>1){
